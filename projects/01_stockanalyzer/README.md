...
To understand how `async` and `await` work internally it is worth to read [this](https://medium.com/@ranjeetdotme/how-async-await-works-in-c-eccf16bd3b90) article.
